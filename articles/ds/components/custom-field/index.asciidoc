...
There is also a helper theme named `whitespace` that can be used when the components the are used in custom field don't have outer margin, by using this theme on the `custom-field` component, `padding-bottom` is increased to compensate for that missing space.
...
[source,html]
----
include::{root}/frontend/demo/component/custom-field/custom-field-whitespace-theme.ts[render,tags=snippet,indent=0,group=TypeScript]
----

[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/customfield/CustomFieldWhitespaceTheme.java[render,tags=snippet,indent=0,group=Java]
----

[source,java]
----
include::{root}/src/main/java/com/vaadin/demo/component/customfield/CoordinateField.java[tags=snippet,indent=0,group=Java]
----
--